...
(N'Hồ Văn Khởi','0975899331','khoihv280490@sv-onuni.edu.vn',N'Hồ Chí Minh','1990-04-28',N'Nam','khoihv280490','123'),
(N'Bùi Nguyễn Dũng','098763312','dung@gmail.com',N'Hồ Chí Minh','1990-09-08',N'Nam','dung','123'),
(N'Nguyễn Thị Vinh','098773332','vinh@gmail.com',N'Đà Nằng','1994-09-08',N'Nữ','vinh','123'),
(N'Lưu Nhật Minh','098763932','minh@gmail.com',N'Hồ Chí Minh','1991-09-08',N'Nữ','minh','123'),
(N'Hà Kiều Ân','098763330','an@gmail.com',N'Hà Nội','1990-09-08',N'Nữ','an','123')
go
insert into HoiDap values
(N'Tôi bị sốt liệu rằng có nhiễm CORONA không ?','2025-01-01','2025-01-02', N'Không . Điều đó bình thuờng.', 1, 1, 1),
(N'Vius lây bệnh qua người bằng con đường nào, thời gian lây bệnh đến phát bệnh trong thời gian bao lâu?','2025-01-01','2025-01-02', N'Virus này lây qua đường không khí, qua giọt bắn nước bọt, qua vật dụng, thời gian ủ bệnh là 14 ngày.', 2, 2, 1),
(N'Tôi muốn hỏi khi nào có thể tới khám?','2025-01-01','2025-01-02', N'Sau khi đặt lịch có thể tới khám, hoặc đến trực tiếp trung tâm hẹn lịch khám nhé.', 1, 2, 1),
(N'Hỏi đáp Khẩu trang y tế bình thường có khả năng cản virus như thế nào ?','2025-01-04','2025-01-07', N'Hiện nay khẩu trang y tế được sử dụng trong việc phòng chống bệnh truyền nhiễm, kể cả bệnh do nCoV. Bộ Y tế khuyến cáo khẩu trang y tế thông thường sử dụng tốt cho người có nguy cơ như làm việc ở cửa khẩu, làm việc ở bệnh viện, đi đến nơi đông người. Khẩu trang N95 sử dụng tốt cho người đi vào ổ dịch, người chăm sóc bệnh nhân tại ổ dịch.', 1, 1, 1),
(N'Tôi muốn tư vấn về sức khỏe.','2025-01-01','2025-01-02', N'Được mời bạn qua trung tâm hoặc để lại số điện thoại.', 3, 1, 1)
go
...
('2024-12-20',N'Khám trong giờ','7:30-10:30', 2),
('2024-12-19',N'Khám trong giờ','13:30-16:30', 3),
('2024-12-15',N'Khám ngoài giờ','16:30-19:30',  4),
('2024-12-21',N'Khám ngoài giờ','19:30-21:30', 5),
('2024-12-15',N'Khám online','7:30-10:30', 3),
('2024-12-16',N'Khám trong giờ','7:30-10:30',  3),
('2024-12-18',N'Khám ngoài giờ','16:30-19:30', 4),
('2024-12-17',N'Khám trong giờ','16:30-19:30', 2),
('2024-12-15',N'Khám online','7:30-10:30', 2),
('2024-12-16',N'Khám trong giờ','7:30-10:30',  2),
('2024-12-15',N'Khám ngoài giờ','16:30-19:30', 2),
('2024-12-17',N'Khám ngoài giờ','16:30-19:30', 5)
go
